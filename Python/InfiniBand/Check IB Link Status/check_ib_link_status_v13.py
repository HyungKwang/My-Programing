...
command2 = "  #python check_ib_link_status_v12.py -i ./tem/ibdiagnet2 -a\n"
command3 = "  #python check_ib_link_status_v12.py -i ./tem/ibdiagnet2 -a -n 20\n"
command4 = "  #python check_ib_link_status_v12.py -i ./tem/ibdiagnet2 -a -n 20 -o  C:\Python39\study\save_backdata.xlsx\n"
