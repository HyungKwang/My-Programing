...
#									 2).If invalid characters (especially NUL \x00 or control characters prohibited by XML 1.0) are mixed in, OpenPyXL will raise an error when writing to an .xlsx (XML) file. (특히 NUL \x00 또는 XML 1.0에서 금지된 제어 문자)가 섞이면 OpenPyXL이 .xlsx(XML)에 쓸 때 오류가 납니다.
#                     So, new function created 'sanitize_str_for_excel(),normalize_vendor(),sanitize_object_columns()  '
#==================================================================================
#
# 
# 
