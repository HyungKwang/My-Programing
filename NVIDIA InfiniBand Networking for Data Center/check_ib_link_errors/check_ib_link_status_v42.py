# =============================================================================
# File name: check_ib_link_status_v37.py
...
command5 = "  #python check_ib_link_status_v37.py -i ./tem/ibdiagnet2 -a -n 20 -s -o C:\\Python39\\study\\save_backdata.xlsx \n"
command6 = "  #python check_ib_link_status_v37.py -i ./tem/ibdiagnet2 -a -n 20 -c -s -o C:\\Python39\\study\\save_backdata.xlsx \n"
command7 = "  #python check_ib_link_status_v37.py -i ./tem/ibdiagnet2 -d"
...
if os.path.isfile(ibdgnt_log):
    with open(ibdgnt_log, "r", encoding="utf-8", errors="ignore") as log_file:
        ...
        Rail_Optimized_line = ""
        _rail_optimized_sym_marker = "Rail Optimized Topology Validation ended with"
        log_file.seek(0)
        for _log_line in log_file:
            if _rail_optimized_sym_marker in _log_line:
                Rail_Optimized_found = True
                Rail_Optimized_line = _log_line.rstrip("\n\r").replace("-W-", "").strip()
                break
