...
command2 = r"  #python check_ib_link_status_v30.py -i ./tem/ibdiagnet2 -a \n"
command3 = r"  #python check_ib_link_status_v30.py -i ./tem/ibdiagnet2 -a -n 20 \n"
command4 = r"  #python check_ib_link_status_v30.py -i ./tem/ibdiagnet2 -a -n 20 -o  C:\Python39\study\save_backdata.xlsx \n"
command5 = r"  #python check_ib_link_status_v30.py -i ./tem/ibdiagnet2 -a -n 20 -s -o C:\Python39\study\save_backdata.xlsx \n"
command6 = r"  #python check_ib_link_status_v30.py -i ./tem/ibdiagnet2 -a -n 20 -c -s -o C:\Python39\study\save_backdata.xlsx \n"
