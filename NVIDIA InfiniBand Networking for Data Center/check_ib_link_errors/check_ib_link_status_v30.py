...
# v30 : 9/19/2024  modified by HyungKwang  removed unnecessary outputs
#==================================================================================
#
# 
# 
...
parser.add_argument(
    ...
    help="reading ibdiagnet2.cables (if file size big), it takes much time. So, To skip cables/optic chcecking",
)
